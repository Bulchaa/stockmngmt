	...
	public function index()
	{
		...
		$this->data['total_paid_orders'] = $this->model_orders->countTotalPaidOrders();
                $this->data['total_orders'] = $this->model_orders->countTotalOrders();
                 $this->data['total_customer_orders'] = $this->model_orders->countTotalCOrders();
                  $this->data['total_loan_orders'] = $this->model_orders->countTotalLOrders();
                   $this->data['total_processed_orders'] = $this->model_orders->countProcessedOrders();
