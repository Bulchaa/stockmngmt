      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createCustomer', $user_permission)): ?>
            <a href="<?php echo base_url('customers/create') ?>" class="btn btn-primary">Add Customer</a>
            <br /> <br />
          <?php endif; ?>
                  ...
                  <?php if($user_data): ?>                  
                    <?php foreach ($user_data as $k => $v): ?>
                      <tr>
                        ...
                        <td><?php echo $v['user_info']['oname']; ?></td>
                        <td><?php echo $v['user_info']['oaddress'] ?></td>
                        ...
                        <td>
                          <?php if(in_array('updateCustomer', $user_permission)): ?>
                            <a href="<?php echo base_url('customers/edit/'.$v['user_info']['id']) ?>" class="btn btn-default"><i class="fa fa-edit"></i></a>
                          <?php endif; ?>
                          <?php if(in_array('deleteCustomer', $user_permission)): ?>
                            <a href="<?php echo base_url('customers/delete/'.$v['user_info']['id']) ?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                          <?php endif; ?>
                        </td>
                      <?php endif; ?>
                      </tr>
