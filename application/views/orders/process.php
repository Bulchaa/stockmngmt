...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Manage
      <small>Orders Process</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Orders Process</li>
    </ol>
  </section>
  ...
  <div class="box">
           <div class="box-header">
            <div class="row">
              <form action="orders/process2" method="POST" autocomplete="off">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'orders/fetchOrdersProcess',
    'order': []
  });
